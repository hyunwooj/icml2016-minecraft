...
require 'util.ExpandAs'
require 'util.SparseMax'
require 'util.MemoryDrop'
...
function create_agent(opt, agent_param)
    local agent = dqn[opt.agent](agent_param)
    return agent
end
